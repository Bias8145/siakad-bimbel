...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#FEF7FF] dark:bg-[#141218] p-4 sm:p-8 font-sans pb-32 lg:pb-8 transition-colors duration-300">
      {/* Header - Responsive Layout Fix */}
      <header className="max-w-7xl mx-auto mb-8 bg-white dark:bg-[#1D1B20] p-6 rounded-[32px] shadow-sm border border-gray-100 dark:border-white/5 no-print">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
          {/* Profile Section */}
          <div className="flex flex-col sm:flex-row items-center gap-5 w-full lg:w-auto text-center sm:text-left">
            <div className="h-20 w-20 rounded-full bg-[#EADDFF] dark:bg-[#4F378B]/30 flex items-center justify-center text-[#21005D] dark:text-[#D0BCFF] font-bold text-2xl overflow-hidden border-4 border-white dark:border-[#2B2930] shadow-lg shadow-purple-100 dark:shadow-none flex-shrink-0">
              {student.photo_url ? (
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#1D1B20] dark:text-white tracking-tight">{student.full_name}</h1>
              <div className="flex items-center justify-center sm:justify-start gap-2 text-sm text-gray-500 dark:text-gray-400 mt-1">
                <span className="bg-gray-100 dark:bg-white/10 px-3 py-1 rounded-full font-medium border border-gray-200 dark:border-white/10">{student.grade_level}</span>
                <span className="text-gray-300 dark:text-gray-600">•</span>
                <span className="text-[#4F378B] dark:text-[#D0BCFF] font-medium flex items-center gap-1">
          ...
          <div className="grid grid-cols-2 sm:flex items-center gap-3 w-full lg:w-auto">
            ...
            <button
              onClick={toggleTheme}
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-white dark:bg-[#2B2930] border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#36343b] transition-colors w-full sm:w-auto"
            >
            ...
            <button 
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-white dark:bg-[#2B2930] border border-gray-200 dark:border-white/10 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#36343b] transition-colors w-full sm:w-auto"
            >
            ...
            <button 
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 font-medium hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors w-full sm:w-auto"
            >
      ...
      <div className="max-w-7xl mx-auto mb-8 no-print">
        <div className="flex justify-start sm:justify-center overflow-x-auto pb-4 scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
          <div className="flex gap-2 bg-white/50 dark:bg-white/5 p-1.5 rounded-full border border-white/60 dark:border-white/10 backdrop-blur-sm">
            {[
              ...
              <button
                ...
                className={clsx(
                  ...
                  activeTab === tab.id 
                    ? "bg-[#4F378B] dark:bg-[#D0BCFF] text-white dark:text-[#381E72] shadow-lg shadow-[#4F378B]/20 scale-100" 
                    : "text-gray-500 dark:text-gray-400 hover:bg-white dark:hover:bg-white/10 hover:text-[#4F378B] dark:hover:text-white"
                )}
              >
      ...
      <main className="max-w-7xl mx-auto pb-12">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-10 h-10 border-4 border-[#4F378B] dark:border-[#D0BCFF] border-t-transparent rounded-full animate-spin mb-4"></div>
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-2 bg-gradient-to-br from-[#4F378B] to-[#21005D] dark:from-[#381E72] dark:to-[#141218] rounded-[32px] p-8 text-white shadow-xl shadow-purple-900/20 relative overflow-hidden group">
                    ...
                    {/* Lottie Animation Positioned Absolute */}
                    <div className="absolute right-[-20px] bottom-[-40px] w-64 h-64 opacity-90 pointer-events-none">
                      {lottieData && <Lottie animationData={lottieData} loop={true} />}
                    </div>
                  </div>

                  {/* Next Class Widget */}
                  <div className="bg-white dark:bg-[#1D1B20] rounded-[32px] p-6 shadow-sm border border-gray-100 dark:border-white/5 flex flex-col relative overflow-hidden">
                    <div className="flex items-center gap-3 mb-4 relative z-10">
                      <div className="bg-orange-100 dark:bg-orange-900/30 p-2.5 rounded-xl">
                        <Clock className="h-5 w-5 text-orange-600 dark:text-orange-400" />
                      </div>
                      <h3 className="font-bold text-gray-900 dark:text-white">{t('next_class')}</h3>
                    </div>
                    
                    {nextClass ? (
                      <div className="relative z-10 flex-1 flex flex-col justify-center">
                        <p className="text-2xl font-bold text-[#1D1B20] dark:text-white mb-1 line-clamp-1">{nextClass.subject}</p>
                        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-3">
                          <User className="h-3 w-3" /> <span>{nextClass.teacher_name}</span>
                        </div>
                        <div className="flex items-center justify-between mt-auto">
                          <div className="bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 text-xs font-bold px-3 py-1.5 rounded-lg flex items-center gap-1">
                            <Clock className="h-3 w-3" />
                      ...
                      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center">
                        <div className="bg-gray-50 dark:bg-white/5 p-3 rounded-full mb-2">
                          <CheckCircle2 className="h-6 w-6 text-green-500" />
                        </div>
                        <p className="text-gray-900 dark:text-white font-bold text-sm">Selesai!</p>
                        <p className="text-gray-400 dark:text-gray-500 text-xs">{t('no_upcoming_class')}</p>
                      </div>
                    )}
                    {/* Decorative Circle */}
                    <div className="absolute top-[-20px] right-[-20px] w-24 h-24 bg-orange-50 dark:bg-orange-900/10 rounded-full opacity-50"></div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 bg-white dark:bg-[#1D1B20] rounded-[32px] p-6 shadow-sm border border-gray-100 dark:border-white/5">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="font-bold text-gray-900 dark:text-white flex items-center gap-2">
                        <TrendingUp className="h-5 w-5 text-blue-500" />
                        {t('subject_performance')}
                      </h3>
                      <div className="text-xs font-bold bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full">
                        Rata-rata: {avgScore}
                      </div>
                    </div>
                      ...
                      {subjectPerformance.length > 0 ? (
                        <ResponsiveContainer width="100%" height="100%">
                          <AreaChart data={subjectPerformance}>
                            ...
                            />
                            <RechartsTooltip 
                              cursor={{ stroke: '#4F378B', strokeWidth: 1 }}
                              contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)', backgroundColor: '#1D1B20', color: '#fff' }}
                            />
                  ...
                  <div className="bg-white dark:bg-[#1D1B20] rounded-[32px] p-6 shadow-sm border border-gray-100 dark:border-white/5 flex flex-col">
                    ...
                    <div className="flex-1 relative flex items-center justify-center">
                      ...
                      {attendanceStats.length > 0 && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                          ...
                          <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Hadir</span>
                        </div>
                      )}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white dark:bg-[#1D1B20] rounded-[32px] p-6 shadow-sm border border-gray-100 dark:border-white/5">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="font-bold text-gray-900 dark:text-white flex items-center gap-2">
                        <Activity className="h-5 w-5 text-purple-500" />
                        {t('recent_attendance')}
                      </h3>
                      <button onClick={() => setActiveTab('academics')} className="text-xs font-bold text-[#4F378B] dark:text-[#D0BCFF] hover:underline">
                        Lihat Semua
                      </button>
                    </div>
                    <div className="space-y-3">
                      {attendance.length > 0 ? attendance.slice(0, 3).map(record => (
                        <div key={record.id} className="flex items-center justify-between p-3 rounded-2xl bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500 dark:text-gray-400">{record.status === 'Present' ? 'Tepat Waktu' : '-'}</p>
                            </div>
                          </div>
                          <span className={clsx(
                  ...
                  {/* Motivation Card */}
                  <div className="bg-[#FFD8E4] dark:bg-[#4A041D] rounded-[32px] p-8 relative overflow-hidden flex flex-col justify-center">
                    <div className="relative z-10">
                      <div className="bg-white/40 dark:bg-white/10 w-12 h-12 rounded-2xl flex items-center justify-center mb-4 backdrop-blur-sm">
                        <Star className="h-6 w-6 text-[#31111D] dark:text-[#FFD8E4]" />
                      </div>
                      <h3 className="text-xl font-bold text-[#31111D] dark:text-[#FFD8E4] mb-2">Tetap Semangat!</h3>
                      <p className="text-[#31111D]/80 dark:text-[#FFD8E4]/80 text-sm mb-6 max-w-xs leading-relaxed">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div className="flex items-center gap-4">
                      <div className="bg-[#EADDFF] dark:bg-[#4F378B]/30 p-3 rounded-2xl">
                        <GraduationCap className="h-6 w-6 text-[#21005D] dark:text-[#D0BCFF]" />
                      </div>
                      <div>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('my_grades')}</h2>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Riwayat nilai ujian & tugas</p>
                      </div>
                    </div>
                    <button 
                      onClick={handlePrint}
                    ...
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="bg-gray-50/50 dark:bg-white/5 border-b border-gray-100 dark:border-white/5">
                          <th className="py-4 px-6 font-bold text-gray-600 dark:text-gray-300 text-sm uppercase tracking-wider">{t('subject')}</th>
                          <th className="py-4 px-6 font-bold text-gray-600 dark:text-gray-300 text-sm uppercase tracking-wider">{t('exam_type')}</th>
                          <th className="py-4 px-6 font-bold text-gray-600 dark:text-gray-300 text-sm uppercase tracking-wider">{t('date')}</th>
                          <th className="py-4 px-6 font-bold text-gray-600 dark:text-gray-300 text-sm uppercase tracking-wider text-right">{t('score')}</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-50 dark:divide-white/5 bg-white dark:bg-[#1D1B20]">
                        {grades.length > 0 ? grades.map(grade => (
                          <tr key={grade.id} className="hover:bg-purple-50/30 dark:hover:bg-white/5 transition-colors">
                            <td className="py-4 px-6 font-bold text-gray-900 dark:text-white">{grade.subject}</td>
                            <td className="py-4 px-6 text-sm text-gray-600 dark:text-gray-400">
                              <span className="bg-gray-100 dark:bg-white/10 px-2 py-1 rounded-md text-xs font-bold uppercase text-gray-500 dark:text-gray-300">
                                {grade.exam_type}
                              </span>
                            </td>
                            ...
                            <td className="py-4 px-6 text-right">
                              <span className={clsx(
                                ...
                                grade.score >= 85 ? "bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-300" : 
                                grade.score >= 70 ? "bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300" : "bg-red-50 text-red-700 dark:bg-red-900/30 dark:text-red-300"
                              )}>
                                {grade.score}
                              </span>
                            </td>
                  ...
                  {schedules.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                      {schedules.map(schedule => (
                        <div key={schedule.id} className="glass-card p-6 border-l-[6px] border-l-[#4F378B] dark:border-l-[#D0BCFF] hover:translate-y-[-4px] transition-transform duration-300">
                          <div className="flex justify-between items-start mb-3">
                            <span className="text-xs font-bold uppercase tracking-wider text-[#4F378B] dark:text-[#D0BCFF] bg-[#EADDFF] dark:bg-[#4F378B]/30 px-2.5 py-1 rounded-lg">
                              {schedule.day_of_week}
                            </span>
                            <span className="text-sm font-bold text-gray-500 dark:text-gray-400 flex items-center gap-1.5 bg-gray-50 dark:bg-white/5 px-2 py-1 rounded-lg">
                              <Clock className="h-3.5 w-3.5" />
                              {schedule.start_time.slice(0, 5)}
                            </span>
                          </div>
                          <h3 className="text-lg font-bold text-[#1D1B20] dark:text-white mb-2">{schedule.subject}</h3>
                          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 font-medium">
                            <User className="h-4 w-4 text-gray-400" />
                            {schedule.teacher_name}
                          </div>
                          {schedule.room && (
                            <div className="mt-3 pt-3 border-t border-gray-100 dark:border-white/5 text-xs text-gray-500 dark:text-gray-400 flex justify-between">
                    ...
                    <div className="glass-panel p-10 text-center text-gray-500 dark:text-gray-400 rounded-3xl border-dashed border-2 border-gray-200 dark:border-gray-800">
                ...
                <div className="m3-card p-8 sm:p-10 relative overflow-hidden">
                  ...
                  <div className="text-center mb-10 relative z-10">
                    <div className="relative w-36 h-36 mx-auto mb-5 group">
                      <div className="w-36 h-36 rounded-full overflow-hidden bg-white dark:bg-[#2B2930] border-4 border-white dark:border-[#2B2930] shadow-xl flex items-center justify-center">
                        {student.photo_url ? (
                          <img src={student.photo_url} alt="Profile" className="w-full h-full object-cover" />
                        ) : (
                          <span className="text-5xl font-bold text-[#21005D] dark:text-[#D0BCFF]">{student.full_name.charAt(0)}</span>
                        )}
                      </div>
                    ...
                    <div className="flex justify-center gap-2 mt-2">
                      <span className="px-3 py-1 rounded-full bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300 text-xs font-bold uppercase tracking-wide border border-green-200 dark:border-green-900/50">
                        {t('active')}
                      </span>
                      <span className="px-3 py-1 rounded-full bg-gray-100 text-gray-600 dark:bg-white/10 dark:text-gray-300 text-xs font-bold uppercase tracking-wide border border-gray-200 dark:border-white/10">
                        {student.grade_level}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                      <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl">
                        ...
                        <p className="text-gray-900 dark:text-white font-bold text-lg break-all">{student.email}</p>
                      </div>
                      <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl">
                    ...
                    <div className="pt-6 border-t border-gray-100 dark:border-white/5">
                      <div className="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-2xl flex gap-4 border border-blue-100 dark:border-blue-900/30">
                        <UserCircle className="h-6 w-6 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" />
                        <div>
                          <h4 className="text-blue-900 dark:text-blue-300 font-bold text-sm mb-1">Info Data Diri</h4>
